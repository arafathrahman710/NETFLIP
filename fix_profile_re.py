...
content = re.sub(
    r"                item \{ Spacer\(modifier = Modifier.height\(24.dp\)\) \}\s+item \{\s+Text\(\"Favourite\", color = Color.White, fontSize = 20.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding\(bottom = 16.dp\)\)\s+\}",
    new_ui,
    content
)
